...
<form id="form1" name="form1" method="post" action="" class="border">
<table align ="center" class="border">
<tr>
<td><label for="buscar">Temas</label></td>
<td><input type="text" name="buscar" id="buscar" class="border" /></td>
...
<br>
<table width="600" class="border border-black" align ="center">
